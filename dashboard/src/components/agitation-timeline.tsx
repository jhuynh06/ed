...
import type { AgitationUpdate, EpisodeStart } from '@/lib/sse-types'
import { mockAgitationHistory } from '@/lib/mock-data'
    ...
    <div className="card p-4 flex flex-col gap-4">
      <div className="flex items-start justify-between">
        <div>
          ...
          <div className="micro mt-1">Real-time sensor fusion · elevated at 8:31</div>
        </div>
